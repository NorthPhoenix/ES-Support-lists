...
label sound_my_list3:
    menu:
        ...
        "Падение в траву":
            ...
            stop sound
            jump sound_my_list3
        "Падение металической двери":
            play sound sfx_fall_metal_door
            "sfx_fall_metal_door"
            stop sound
            jump sound_my_list3
        "Падение на деревянный пол":
...
label sound_my_list_eng:
    menu:
        ...
        "Bus":
            ...
            jump sound_my_list_eng
        ">>Next page<<":
            jump sound_my_list2_eng
        ">>Back<<":
            jump start_my_list


label sound_my_list2_eng:
    menu:
        "Page 2"
        "Body fall in bush":
            play sound sfx_bush_body_fall
